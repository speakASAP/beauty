  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-dark p-4">
      <div className="w-full max-w-md p-6 rounded-2xl bg-base border border-borderLight shadow-lg">
        <h1 className="text-xl font-heading font-semibold text-dark mb-2">Platform Login</h1>
        <p className="text-sm text-soft mb-6">Sign in with your platform account (auth-microservice)</p>
        ...
        <p className="mt-4 text-center text-sm text-soft">
          No account? <Link to="/platform-register" className="text-accent hover:underline">Register</Link>
        </p>
