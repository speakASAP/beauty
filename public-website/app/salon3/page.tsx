...
export default function Salon3() {
  return (
    <div className="salon-landing salon-serenity">
      {/* Navigation */}
      <nav className="salon-nav">
        <div className="container">
          <a href="/salon3" className="nav-logo">Serenity Beauty Lounge</a>
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              Serenity
              <br />
              <span className="hero-title-accent">Beauty Lounge</span>
            </h1>
          ...
          <div className="about-content">
            <div className="about-text">
              <p className="lead-text">
                Serenity Beauty Lounge – místo, kde se setkává sofistikovaná elegance s přirozenou krásou.
              </p>
              <p>
                Každý detail má svůj význam. Každý dotek je promyšlený. Každá návštěva je zážitek, který vás posune blíže k vašemu ideálnímu já. Naše lounge kombinuje nejnovější trendy s nadčasovou elegancí.
              </p>
              <p>
                Jsme tým odborníků, kteří chápou, že skutečná krása vychází zevnitř. Naším cílem je zdůraznit vaši přirozenou krásu a dodat vám sebevědomí, které si zasloužíte.
              </p>
            </div>
            <div className="about-image">
              <div className="image-wrapper">
                <img src="https://yaraspace.cz/wp-content/uploads/2025/05/yaraspace_intro.webp" alt="Serenity Beauty Lounge" />
        ...
        <div className="container">
          ...
          <div className="why-grid">
            ...
            <div className="why-item">
              <div className="why-icon">🌿</div>
              <h3>Atmosféra</h3>
              <p>Serenity Beauty Lounge není jen salon krásy, ale místo, kde se zastaví čas. Příjemná hudba, vůně čaje, teplé úsměvy.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="testimonials-grid">
            ...
            <div className="testimonial-card">
              <div className="testimonial-stars">★★★★★</div>
              <p className="testimonial-text">
                "Nejednou jsem využila služby Serenity Beauty Lounge a jsem velmi spokojená!!! Kvalita produktů a úroveň provedení práce je vždy na vysoké úrovni!!!"
              </p>
          ...
          <div className="contact-content">
            <div className="contact-info">
              ...
              <div className="contact-item">
                ...
                <p>Velké náměstí 12<br />Kroměříž, 767 01</p>
              </div>
              <div className="contact-item">
                <strong>Telefon:</strong>
                <p><a href="tel:+420776886468">+420 776 886 468</a></p>
              </div>
              <div className="contact-item">
                <strong>Email:</strong>
                <p><a href="mailto:info@serenitylounge.cz">info@serenitylounge.cz</a></p>
              </div>
              <div className="contact-item">
        ...
        <div className="container">
          <div className="footer-content">
            ...
            <p className="footer-copyright">
              Serenity Beauty Lounge © 2026 Všechna práva vyhrazena
            </p>
          </div>
        </div>
      </footer>
