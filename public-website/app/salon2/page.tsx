...
export default function Salon2({ tenantInfo }: { tenantInfo: TenantInfo }) {
  const salonName = tenantInfo?.name || 'Lavender Dreams'
  ...
  return (
    <div className="salon-landing salon2">
      {/* Navigation */}
      ...
      <section className="hero-section">
        <div className="hero-organic-shapes">
        ...
        <div className="container">
          <div className="hero-content">
            <div className="hero-text">
              <div className="hero-badge">Vlasový Wellness</div>
              <h1 className="hero-title">
                {salonName}
                <span className="title-accent">Hair & Spa</span>
              </h1>
          ...
          <div className="services-grid">
            <div className="service-card">
              <div className="service-image-wrapper">
                ...
                <div className="service-badge">Novinka</div>
              </div>
            ...
            <div className="service-card">
              <div className="service-image-wrapper">
                ...
                <div className="service-badge">Populární</div>
              </div>
              <div className="service-content">
                <h3>Airtouch</h3>
            ...
            <div className="service-card">
              <div className="service-image-wrapper">
                ...
                <div className="service-badge">Doporučujeme</div>
              </div>
              <div className="service-content">
      ...
      <section id="booking" className="cta-section">
        <div className="cta-organic-shapes">
          <div className="organic-shape shape4"></div>
          <div className="organic-shape shape5"></div>
        </div>
        <div className="container">
