...
export default function Salon1() {
  return (
    <div className="salon-landing salon-luna">
      {/* Navigation */}
      <nav className="salon-nav">
        <div className="container">
          <a href="/salon1" className="nav-logo">Luna Beauty & Spa</a>
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              Luna
              <br />
              <span className="hero-title-accent">Beauty & Spa</span>
            </h1>
          ...
          <div className="about-content">
            <div className="about-text">
              <p className="lead-text">
                Luna Beauty & Spa – to je vaše dobrá nálada, sebevědomí a ten pocit, že jste to vy, jen ještě krásnější.
              </p>
              <p>
                Odvážné mikádo, nová energie, dokonalé svatební fotografie. První rande, na kterém se cítíte jako královna. Účes, který vám opravdu sluší! Za tím vším stojí lidé, kteří milují svou práci a dělají ji srdcem.
              </p>
              <p>
                Jsme tým profesionálů, který vidí krásu v každém a ví, jak ji zvýraznit. Vaše krása si zaslouží zazářit. My víme, jak na to.
              </p>
            </div>
            <div className="about-image">
              <div className="image-wrapper">
                <img src="https://yaraspace.cz/wp-content/uploads/2025/05/yaraspace_intro.webp" alt="Luna Beauty & Spa" />
        ...
        <div className="container">
          ...
          <div className="why-grid">
            ...
            <div className="why-item">
              <div className="why-icon">🌙</div>
              <h3>Atmosféra</h3>
              <p>Luna Beauty & Spa není jen salon krásy, ale místo, kde se zastaví čas. Příjemná hudba, vůně čaje, teplé úsměvy.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="testimonials-grid">
            ...
            <div className="testimonial-card">
              <div className="testimonial-stars">★★★★★</div>
              <p className="testimonial-text">
                "Nejednou jsem využila služby Luna Beauty & Spa a jsem velmi spokojená!!! Kvalita produktů a úroveň provedení práce je vždy na vysoké úrovni!!!"
              </p>
          ...
          <div className="contact-content">
            <div className="contact-info">
              ...
              <div className="contact-item">
                ...
                <p>Havířská 123<br />Kroměříž, 767 01</p>
              </div>
              <div className="contact-item">
                <strong>Telefon:</strong>
                <p><a href="tel:+420776886466">+420 776 886 466</a></p>
              </div>
              <div className="contact-item">
                <strong>Email:</strong>
                <p><a href="mailto:info@lunabeauty.cz">info@lunabeauty.cz</a></p>
              </div>
              <div className="contact-item">
                <strong>Otevírací doba:</strong>
                <p>Po - Pá: 9:00 - 18:00<br />So: 9:00 - 15:00<br />Ne: Zavřeno</p>
              </div>
            </div>
        ...
        <div className="container">
          <div className="footer-content">
            ...
            <p className="footer-copyright">
              Luna Beauty & Spa © 2026 Všechna práva vyhrazena
            </p>
          </div>
        </div>
      </footer>
