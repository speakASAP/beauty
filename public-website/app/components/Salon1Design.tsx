...
interface Salon1DesignProps {
  tenant: TenantInfo
}

export default function Salon1Design({ tenant }: Salon1DesignProps) {
  const salonName = tenant.name || 'Luna Beauty & Spa'
        ...
        <div className="container">
          <div className="hero-content">
            ...
            <h1 className="hero-title">
              {salonName.split(' ')[0]}
              <br />
              <span className="hero-title-accent">{salonName.split(' ').slice(1).join(' ')}</span>
            </h1>
          ...
          <div className="about-content">
            <div className="about-text">
              <p className="lead-text">
                {salonName} – to je vaše dobrá nálada, sebevědomí a ten pocit, že jste to vy, jen ještě krásnější.
              </p>
              <p>
        ...
        <div className="container">
          ...
          <div className="testimonials-grid">
            ...
            <div className="testimonial-card">
              <div className="testimonial-stars">★★★★★</div>
              <p className="testimonial-text">
                "Nejednou jsem využila služby {salonName} a jsem velmi spokojená!!! Kvalita produktů a úroveň provedení práce je vždy na vysoké úrovni!!!"
              </p>
        ...
        <div className="container">
          <div className="footer-content">
            ...
            <p className="footer-copyright">
              {salonName} © 2026 Všechna práva vyhrazena
            </p>
          </div>
        </div>
      </footer>
