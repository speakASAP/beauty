...
interface Salon2DesignProps {
  tenant: TenantInfo
}

export default function Salon2Design({ tenant }: Salon2DesignProps) {
  const salonName = tenant.name || 'Aurora Hair Studio'
        ...
        <div className="container relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex gap-5 justify-center flex-wrap">
              ...
              <a href="#services" className="btn btn-secondary">Objevte naše služby</a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 md:order-2">
              <p className="text-xl font-semibold text-dark mb-6">{salonName} – místo, kde se vaše krása probouzí a září v plné síle.</p>
              <p className="text-soft mb-4">Každý účes je umělecké dílo. Každá barva je příběh. Každá návštěva je zážitek. Naše studio kombinuje nejnovější techniky s tradičním řemeslem, abychom vám přinesli výsledek, který předčí vaše očekávání.</p>
              <p className="text-soft">Jsme tým vášnivých profesionálů, kteří věří, že každá žena si zaslouží vypadat a cítit se jako královna. Vaše sebevědomí je naší prioritou.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="mb-6">
                ...
                <p className="text-soft">Po - Pá: 9:00 - 19:00<br />So: 9:00 - 16:00<br />Ne: Zavřeno</p>
              </div>
            </div>
            <div id="booking">
