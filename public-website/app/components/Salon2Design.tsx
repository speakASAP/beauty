        ...
        <div className="container">
          ...
          <div className="about-content">
            ...
            <div className="about-text">
              <p className="lead-text">{salonName} – místo, kde se vaše krása probouzí a září v plné síle.</p>
              <p>Každý účes je umělecké dílo. Každá barva je příběh. Každá návštěva je zážitek. Naše studio kombinuje nejnovější techniky s tradičním řemeslem, abychom vám přinesli výsledek, který předčí vaše očekávání.</p>
              <p>Jsme tým vášnivých profesionálů, kteří věří, že každá žena si zaslouží vypadat a cítit se jako královna. Vaše sebevědomí je naší prioritou.</p>
            </div>
          </div>
        </div>
      </section>
