      ...
      <section className="relative min-h-[90vh] flex items-center justify-center py-section-mobile md:py-section-desktop overflow-hidden mt-20">
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl ml-auto mr-[10%]">
            <div className="relative bg-light rounded-2xl p-8 md:p-12 border border-[#be845f] shadow-xl">
              <div className="text-dark text-center md:text-left">
                <div className="inline-block px-4 py-2 mb-8 bg-accent/60 rounded-full text-dark font-semibold text-sm tracking-wider uppercase font-poppins">
                  {t('hero.badge')}
                </div>
                <h1 className="mb-8 text-dark text-4xl md:text-6xl lg:text-7xl font-bold">
                  {t('hero.title')}
                </h1>
                <div className="mb-8">
                  <div className="inline-block px-4 py-2 bg-accent/70 rounded-full text-dark font-semibold text-sm md:text-base font-poppins">{t('hero.subtitle')}</div>
                </div>
                <p className="text-dark max-w-3xl mx-auto md:mx-0 font-poppins text-lg md:text-xl leading-relaxed">
                  {t('hero.description')}
                </p>
              </div>
            </div>
